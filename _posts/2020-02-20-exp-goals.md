...
We can see that the optimized gradient boosted trees and logistic regression models performed similarly on the validation set. I decided to carry on with the logistic regression model for its interpretability. 

##Logistic regression xG model: a closer look
